            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        ...
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="MSG91_KEY">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('AUTH KEY')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MSG91_KEY" value="{{  env('MSG91_KEY') }}" placeholder="AUTH KEY" required>
                            </div>
                        </div>
                         <div class="form-group row">
                            <input type="hidden" name="types[]" value="MSG_ROUTE">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('ROUTE')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <select class="form-control aiz-selectpicker" name="ROUTE" required>
                                    <option value="1" @if (env('MSG_ROUTE') == "1") selected @endif>{{translate('Promotional Use')}}</option>
                                    <option value="4" @if (env('MSG_ROUTE') == "4") selected @endif>{{translate('Transactional Use')}}</option>
                                </select>
                            </div>
                        </div>
                      <div class="form-group row">
                            <input type="hidden" name="types[]" value="MSG_SENDER_ID">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('SENDER ID')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MSG_SENDER_ID" value="{{  env('MSG_SENDER_ID') }}" placeholder="6 digit SENDER ID" >
                            </div>
                        </div>
