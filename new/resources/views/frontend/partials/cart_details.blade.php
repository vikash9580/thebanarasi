                                    ...
                                    <div class="col-lg col-6 order-4 order-lg-0">
                                        @if($cartItem['digital'] != 1)
                                            <div class="row no-gutters align-items-center aiz-plus-minus mr-3">
                                                ...
                                                <input type="text" name="quantity[{{ $cartItem->id }}]" class="col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="{{ $cartItem['quantity'] }}" min="1" max="{{$product['max_qty']}}" readonly onchange="updateQuantity({{ $cartItem->id  }}, this)">
