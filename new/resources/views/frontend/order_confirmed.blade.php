                                    ...
                                    <div class="col-md-6">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td><!-- {{ single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax')) }} -->{{ single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax')) }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tbody>
                                               ...
                                               @if(json_decode($order->shipping_address)->state =='Uttar Pradesh')
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <strong><span>{{ single_price($order->grand_total-($order->coupon_discount+$order->wallet_discount)) }}</span></strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
