...
<section class="mb-5">
    <div class="container text-left">
        <div class="row">
            <div class="col-xxl-5 col-xl-10 col-lg-8 mx-auto">
                <form class="" action="{{ route('orders.track') }}" method="GET" enctype="multipart/form-data">
                    <div class="bg-white">
                        ...
                        <div class="form-box-content">
                            <div class="row">
                             <div class="col-md-6">
                                <lebel>Order ID</lebel>
                            <div class="form-group">
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Order Code')}}" name="order_code" value="{{request('order_code')}}" required>
                            </div>
                            </div>
                              
                            <div class="col-md-12">
                                <button type="submit" class="cell btn btn-primary">{{ translate('Track Order')}}</button>
                            </div>
                            </div>
                        </div>
                    </div>
