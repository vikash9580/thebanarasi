            		...
            		<div class="col-md-4">
            			<div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
            				<div class="px-3 pt-3">
                                    ...
                                    <div class="h3 fw-700">{{ App\Models\Cart::where('user_id',Auth::user()->id)->where('payment_status',0)->get()->count() }} Product(s)</div>
                                  ...
                                  @if($address != null)
                                      <ul class="list-unstyled mb-0">
                                          ...
                                          <li class=" py-2"><span>{{ translate('Country') }} : {{ $address->country }}</span></li>
                                            <li class=" py-2"><span>{{ translate('State') }} : {{ $address->state }}</span></li>
