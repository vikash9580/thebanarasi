                ...
                <div class="aiz-user-panel">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('pdf.download_sub_category') }}"><button class="btn btn-primary mt-2">{{ translate('Download Sub category')}}</button></a>
                            <a href="{{ route('pdf.download_sub_sub_category') }}"><button class="btn btn-primary mt-2">{{ translate('Download Sub Sub category')}}</button></a>
