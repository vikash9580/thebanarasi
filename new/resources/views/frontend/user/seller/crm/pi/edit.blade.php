     ...
     <div class="container-fluid">
        ...
        <div class="row">
                          ...
                          <div class="card-body">
                              ...
                              <form class="form-horizontal needs-validation" id="quotation_form" action="{{route('crm_seller.order_store')}}" method="POST" enctype="multipart/form-data" novalidate >

                    @csrf
                        <input type="hidden" name="pi_number" value="{{$data->pi_number}}" />
                        @if(!empty($data->quotation_number))
                         <input type="hidden" name="contact_enquiry_id" value="{{$data->contact_enquiry_id}}" />
                        @endif
                    <!-- Modal body -->
                        ...
                        <div class="row">
                         ...
                         <input type="hidden" name="type_from" value="{{request('type')}}" />
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="{{translate('Phone')}}" id="mobile" name="mobile1" class="form-control" value="{{$data->phone}}" readonly required>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Name')}}" id="name" name="name" class="form-control" value="{{$data->name}}" readonly required>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" placeholder="{{translate('Email')}}" id="email" name="email" class="form-control" value="{{$data->email}}" readonly >
                            ...
                            <div class="row quotaion_information col-sm-12" id="quotaion_information">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="{{translate('Phone')}}" id="other_phone" name="other_phone" class="form-control" value="{{ $data->other_phone }}" readonly >
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{translate('Name')}}" id="other_name" name="other_name" class="form-control" value="{{ $data->other_name}}" readonly >
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" placeholder="{{translate('Email')}}" id="other_email" name="other_email" class="form-control" value="{{ $data->other_email}}" readonly >
                         ...
                         <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="business_name" id="business_name" class="form-control " required data-placeholder="{{ translate('Sellect Bussiness Name') }}" readonly >
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Quotation Tilte')}}" id="quotation_name" name="quotation_name" class="form-control" value="{{$data->quotation_name}}" required readonly >
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" placeholder="{{translate('Date')}}" name="date" id="date" class="form-control" value='{{$data->date}}' readonly >
               ...
               <!--<button type="button" class="btn btn-primary waves-effect waves-light product_all" data-bs-toggle="modal" data-bs-target="#con-close-modal">+</button>-->
                 ...
                 @php  $pi = App\Pi::where('pi_number',$data->pi_number)->get();   @endphp
                                    <tbody>
                                     @foreach ($pi as $quotation_data)
                                        <tr>
                                            <td>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="{{translate('Delivery / Courier Charge')}}" id="courier_charge" name="courier_charge" onchange="final_total_discount()" class="form-control" value="{{$data->courier_charge}}" readonly>
                            ...
                            <!--        <input type="number" placeholder="{{translate('total')}}" id="total" name="total" class="form-control" value="" readonly>-->
                          ...
                          <label class="control-label" for="grand_total">Grand Total</label>
                             ...
                             <input type="number" placeholder="Discount Total" id="grand_total" name="grand_total" class="form-control" value="{{$data->total}}" readonly >
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <button type="submit" onclick="data_save()" class="btn btn-sm btn-primary">{{translate('Confirmed Order')}}</button>
