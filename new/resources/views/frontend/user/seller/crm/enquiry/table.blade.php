                ...
                <tr>
                    ...
                    <td>
                      <a href="{{route('contact_form.edit',$item->contact_enquiry_id)}}" class="btn btn-soft-info btn-icon btn-circle btn-sm route_action">
                       ...
                       <a href="{{route('notification_template_index','id='.json_encode([$item->contact_form->id]))}}" class="btn btn-soft-info btn-icon btn-circle btn-sm route_action">
                        <i class="fa fa-paper-plane" aria-hidden="true"></i>
                      </a>
                       <a href="{{route('call_notification','phone='.$item->contact_form->phone)}}" id="{{$item->contact_form->id}}" class="btn btn-soft-info btn-icon btn-circle btn-sm call_action">
                        <i class="fa fa-phone" aria-hidden="true"></i>
                      </a>
                       <a href="{{route('crm_quotation')}}?type=enquiry&id={{$item->contact_enquiry_id}}"  class="btn btn-soft-info btn-icon btn-circle btn-sm route_action">
                  ...
                  @endforeach 
                            ...
                            @include('backend.pagination',['list' =>$data,'class'=>'enquiry_index'])
                        </div>                           
