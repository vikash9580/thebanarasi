...
<div class="col-lg-8 mx-auto">
	<form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form" onsubmit="check_product_name()">
		<input name="_method" type="hidden" value="POST">
		<input type="hidden" name="id" value="{{ $product->id }}">
			 <input type="hidden" name="brand_ids" value="{{ $brand_ids }}">
		 <input type="hidden" name="type" value="{{ $type }}">
		   <input type="hidden" name="sort_search" value="{{ $sort_search }}">
		...
		<div class="card">
			...
			<div class="card-body">
                ...
                <div class="form-group row">
					...
					<select class="form-control aiz-selectpicker" name="vendor[]" id="vendor"  data-live-search="true" multiple>
					    	<option value="">Select Vendor</option>	
									 @foreach (\App\Vendor::where('status', 1)->get() as $key => $vendor)
                                         <option value="{{ $vendor->id }}"@if(in_array($vendor->id,json_decode($product->vendor))){{ 'selected'  }} @endif >{{ $vendor->name }}</option>
                                     @endforeach
					...
					<select class="form-control aiz-selectpicker" name="product_type" id="product_type"  data-live-search="true" >
					    	<option value="">Select Product Type</option>	
								<option value="generic" <?php if(strtolower($product->product_type) == 'generic') echo "selected"; ?>>Generic</option>	
								<option value="patent" <?php if(strtolower($product->product_type) == 'patent') echo "selected"; ?>>Patent</option>
							    <option value="surgical" <?php if(strtolower($product->product_type) == 'surgical') echo "selected"; ?>>Surgical</option>
						        <option value="general" <?php if(strtolower($product->product_type) == 'general') echo "selected"; ?>>General</option>
						        <option value="eye drop" <?php if(strtolower($product->product_type) == 'eye drop') echo "selected"; ?>>Eye Drop</option>
						        <option value="injection" <?php if(strtolower($product->product_type) == 'injection') echo "selected"; ?>>Injection</option>
						        <option value="costly item"  <?php if(strtolower($product->product_type) == 'costly item') echo "selected"; ?>>Costly Item</option>
		                    	<option value="miscellaneous"  <?php if(strtolower($product->product_type) == 'miscellaneous') echo "selected"; ?>>Miscellaneous</option>
						</select>
					</div>
				</div>
                ...
                <div class="form-group row" id="brand">
					...
					<div class="col-md-8">
						<select class="form-control aiz-selectpicker" name="is_rx" id="is_rx"  data-live-search="true">
							...
							<option value="yes" @if($product->is_rx == 'yes') selected @endif>Yes</option>
							<option value="no" @if($product->is_rx == 'no') selected @endif>No</option>	
						</select>
					</div>
				</div>
                <div class="form-group row">
				...
				<div class="form-group row">
					<label class="col-lg-3 col-from-label">Maximum Qty</label>
					<div class="col-lg-8">
						<input type="number" class="form-control" name="max_qty" value="@if($product->max_qty <= 1){{1}}@else{{$product->max_qty}}@endif" min="1" required>
					</div>
				</div>
				 <div class="form-group row">
					<label class="col-lg-3 col-from-label">HSN/SAC Code</label>
					<div class="col-lg-8">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('About')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-9">
                        <textarea class="aiz-text-editor" name="description">{{$product->getTranslation('description')}}</textarea>
                    </div>
                </div>
                	<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Composition')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-9">
                        <textarea class="aiz-text-editor" name="composition">{{$product->composition}}</textarea>
                    </div>
                </div>
                	<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Specification')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-9">
                        <textarea class="aiz-text-editor" name="specification">{{$product->specification}}</textarea>
                    </div>
                </div>
                	<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Caution')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-9">
                        <textarea class="aiz-text-editor" name="caution">{{$product->caution}}</textarea>
                    </div>
                </div>
                	<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Side Effect')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-9">
                        <textarea class="aiz-text-editor" name="side_effect">{{$product->side_effect}}</textarea>
                    </div>
                </div>
                	<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('How To Use')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-9">
                        <textarea class="aiz-text-editor" name="how_to_use">{{$product->how_to_use}}</textarea>
                    </div>
                </div>
                	<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('FAQs')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-9">
                        <textarea class="aiz-text-editor" name="faq">{{$product->faq}}</textarea>
                    </div>
                </div>
			</div>
		</div>
