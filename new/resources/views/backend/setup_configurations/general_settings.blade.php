            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('GSTIN')}}</label>
                            <div class="col-sm-9">
                                 <input type="hidden" name="types[]" value="gstin">
                                <input type="text" name="gstin" class="form-control" value="{{ get_setting('gstin') }}">
                            </div>
                        </div>
                        <div class="form-group row">
