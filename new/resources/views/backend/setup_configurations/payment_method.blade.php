...
<div class="row">
    ...
    <div class="col-md-6">
     ...
     <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6 ">{{translate('CCAvenue Credential')}}</h5>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group row">
                        <input type="hidden" name="types[]" value="CCAVENUE_KEY">
                        <div class="col-md-4">
                            <label class="col-from-label">{{translate('WORKING KEY')}}</label>
                        </div>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="CCAVENUE_KEY" value="{{  env('CCAVENUE_KEY') }}" placeholder="{{ translate('WORKING KEY') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <input type="hidden" name="types[]" value="CCAVENUE_CODE">
                        <div class="col-md-4">
                            <label class="col-from-label">{{translate('ACCESS CODE')}}</label>
                        </div>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="CCAVENUE_CODE" value="{{  env('CCAVENUE_CODE') }}" placeholder="{{ translate('ACCESS CODE') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <input type="hidden" name="types[]" value="CCAVENUE_MERCHANTID">
                        <div class="col-md-4">
                            <label class="col-from-label">{{translate('MERCHANT ID')}}</label>
                        </div>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="CCAVENUE_MERCHANTID" value="{{  env('CCAVENUE_MERCHANTID') }}" placeholder="{{ translate('MERCHANT ID') }}" required>
                        </div>
                    </div>
                    <div class="form-group mb-0 text-right">
                        <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
    ...
    <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title text-center">{{translate('Flutterwave Credential')}}</h3>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
