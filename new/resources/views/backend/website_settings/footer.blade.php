...
@section('content')
    ...
    <div class="card">
    	<div class="card-header">
    		<h6 class="fw-600 mb-0">{{ translate('Footer Widget') }}</h4>
    	</div>
    	<div class="card-body">
    		<div class="row gutters-10">
    			<div class="col-lg-6">
    				<div class="card">
    					<div class="card-header">
    						<h4 class="mb-0">{{ translate('About Widget') }}</h4>
    					</div>
    					<div class="card-body">
    			...
    			<div class="col-lg-6">
                    <div class="card">
    					<div class="card-header">
    						<h4 class="mb-0">{{ translate('Contact Info Widget') }}</h4>
    					</div>
    					<div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    							@csrf
                ...
                <div class="col-lg-12">
                    <div class="card">
    					<div class="card-header">
    						<h4 class="mb-0">{{ translate('Link Widget One') }}</h4>
    					</div>
    					<div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
    ...
    <div class="card">
    	<div class="card-header">
    		<h6 class="fw-600 mb-0">{{ translate('Footer Bottom') }}</h4>
    	</div>
        <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
           <div class="card-body">
                <div class="card">
                    <div class="card-header">
          						<h4 class="mb-0">{{ translate('Copyright Widget ') }}</h4>
          					</div>
                    <div class="card-body">
                        <div class="form-group">
                ...
                <div class="card">
                  <div class="card-header">
        						<h4 class="mb-0">{{ translate('Social Link Widget ') }}</h4>
        					</div>
                  <div class="card-body">
                ...
                <div class="card">
                  <div class="card-header">
        						<h4 class="mb-0">{{ translate('Payment Methods Widget ') }}</h4>
        					</div>
                  <div class="card-body">
                      <div class="form-group">
