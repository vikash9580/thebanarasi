    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="">
                ...
                <a href="{{ route('pdf.download_sub_category') }}"><button class="btn btn-info">{{translate('Download Sub category')}}</button></a>
                <a href="{{ route('pdf.download_sub_sub_category') }}"><button class="btn btn-info">{{translate('Download Sub Sub category')}}</button></a>
