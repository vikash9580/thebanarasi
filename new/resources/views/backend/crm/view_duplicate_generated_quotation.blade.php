...
<div class="col-lg-10 mx-auto">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{translate('Duplicate Quotation')}}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('crm.generate_duplicate_quotation') }}" method="POST">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select name="business_name" id="business_name" class="form-control aiz-selectpicker" required data-placeholder="{{ translate('Sellect Bussiness Name') }}">
                            <option value="mz_group_textiles" @if(isset($quotation[0]['business_name']) && $quotation[0]['business_name']== 'mz_group_textiles'){{ 'selected' }}@endif>{{translate('MZ GROUP TEXTILES') }}</option>
                            <option value="the_banarasi_saree" @if(isset($quotation[0]['business_name']) && $quotation[0]['business_name']== 'the_banarasi_saree'){{ 'selected' }}@endif>{{translate('THE BANARASI SAREE') }}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{translate('Quotation Title')}}" id="name" name="title" class="form-control" value="{{ $quotation[0]->quotation_name }}">
                    </div>
                </div>
            ...
            --}}
                        ...
                        <tbody id="product_table" >
                            ...
                            @foreach ($quotation as $quotation_data)
                                <tr>
                                    ...
                                    <td><input type="number" name="wholesale_quintity[]" id="wholesale_quintity_{{$i}}" min="0" step="1" class="form-control all_{{$i}}" onchange="calculation({{$i}})" value="{{$quotation_data->wholesale_quintity}}">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="number" placeholder="{{translate('Delivery / Courier Charge')}}" id="courier_charge" name="courier_charge" value="{{$quotation[0]->courier_charge}}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" placeholder="{{translate('total')}}" id="total" name="total" class="form-control" value="{{$quotation[0]->total}}" readonly>
                        </div>
                    </div>
                </div>
               ...
               {{-- <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="date" placeholder="{{translate('Delivery Date')}}" id="delivery_date" name="delivery_date" value="{{old('delivery_date')}}" class="form-control " >
                    </div>
                </div> 
                <div class="form-group row">
                    ...
                    <div class="row gutters-5">
                        ...
                        @foreach ($addresses as $key => $address)
                            <div class="col-md-6 mb-3">
                                <label class="aiz-megabox d-block mb-0 border p-3 rounded mb-3 c-pointer bg-light">
                ...
                --}}
                <div class="form-group mb-0 text-right">
                    <button type="submit" class="btn btn-primary">{{translate('Duplicate Quotation')}}</button>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    //         var courier_charge = $(this).val();
    //         var total = $('#total').val();
    //         //console.log(courier_charge);
    //         final = parseFloat(total) + parseFloat(courier_charge);
    //         $('#total').val(final); 
    //     });
    // });
</script>
