    ...
    public function store(Request $request)
    {
        ...
        if($flash_deal->save()){
            foreach ($request->products as $key => $product) {
                ...
                $flash_deal_product->wholesale_discount = $request['wholesale_discount_'.$product];
                $flash_deal_product->wholesale_discount_type = $request['wholesale_discount_type_'.$product];
