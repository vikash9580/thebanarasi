                                ...
                                <div class="">
                                    @if(Auth::check())
                                      @if(Auth::user()->is_wholesale_customer==1 && Auth::user()->validate_wholesale_customer==1)
                                          ...
                                          <del class="opacity-60 fs-15" >{{ home_base_price_wholesale($product->id) }}</del>
                                          @endif
                                            <span class="fw-600 fs-16 text-primary" >{{ home_discounted_base_price_wholesale($product->id) }}</span>
