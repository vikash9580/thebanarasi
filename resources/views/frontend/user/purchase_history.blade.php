                                        ...
                                        @if (count($order->orderDetails) > 0)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    @if ($order->orderDetails->first()->delivery_status == 'pending' || $order->orderDetails->first()->delivery_status=='confirmed')
                                                        <a href="{{route('orders.cancel', $order->id)}}" class="btn btn-soft-danger btn-icon btn-circle btn-sm"  title="{{ translate('Cancel') }}">
                                                          x
                                                       </a>
                                                    @endif
