                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            <div class="text-center pt-4">
                                <h1 class="h4 fw-600">
                                    {{ translate('Apply for wholesale account.')}}
                                </h1>
                            </div>
                                ...
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden"  value="1" name="is_wholesale_customer">
                                 ...
                                 <div class="form-group">
                                            <input type="text" class="form-control{{ $errors->has('shop_name') ? ' is-invalid' : '' }}" value="{{ old('shop_name') }}" placeholder="{{  translate('Shop Name') }}" name="shop_name">
                                            <!--@if ($errors->has('name'))-->
                                            <!--    <span class="invalid-feedback" role="alert">-->
                                            <!--        <strong>{{ $errors->first('name') }}</strong>-->
                                            <!--    </span>-->
                                         ...
                                         <div class="form-group">
                                            <input type="text" class="form-control{{ $errors->has('gst_number') ? ' is-invalid' : '' }}" value="{{ old('gst_number') }}" placeholder="{{  translate('GST number') }}" name="gst_number">
                                            <!--@if ($errors->has('name'))-->
                                            <!--    <span class="invalid-feedback" role="alert">-->
                                            <!--        <strong>{{ $errors->first('name') }}</strong>-->
                                            <!--    </span>-->
