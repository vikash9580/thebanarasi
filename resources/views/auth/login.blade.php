...
<div class="h-100 bg-cover bg-center d-flex align-items-center" style=  "background-image: url({{ uploaded_asset(get_setting('admin_login_background')) }});padding: 8em 0;">
    <div class="container">
        <div class="row">
                                ...
                                @if(env('MAIL_USERNAME') != null && env('MAIL_PASSWORD') != null)
                                    <div class="col-sm-6">
                                        <div class="text-right">
                                            <a href="{{ route('password.request') }}" class="text-white fs-14">{{translate('Forgot password')}} ?</a>
                                        </div>
                                    </div>
                                @endif
                            </div>
