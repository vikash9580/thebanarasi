    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'msg91')" @if(App\OtpConfiguration::where('type', 'msg91')->first() != null && \App\OtpConfiguration::where('type', 'msg91')->first()->value == 1) checked @endif>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
