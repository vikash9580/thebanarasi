          ...
          <form class="p-4" action="{{ route('flash_deals.update', $flash_deal->id) }}" method="POST">
            @csrf
              ...
              <input type="hidden" name="lang" value="{{ $lang }}">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-from-label" for="name">{{translate('Text Color')}}</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control aiz-date-range" value="{{ $start_date.' to '.$end_date }}" name="date_range" placeholder="Select Date" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to ">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="products">{{translate('Products')}}</label>
                    <div class="col-sm-9">
                        <select name="products[]" id="products" class="form-control aiz-selectpicker" multiple required data-placeholder="{{ translate('Choose Products') }}">
