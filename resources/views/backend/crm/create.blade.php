...
<div class="col-lg-12 mx-auto">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{translate('Create Seller')}}</h5>
        </div>

        <form class="form-horizontal" action="{{ route('crm.store') }}" method="POST" enctype="multipart/form-data">
        	@csrf
            <input type="hidden" name="add_by" value="{{ Auth::user()->id }}" class="form-control">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" placeholder="{{translate('Phone 1')}}" id="mobile1" name="mobile1" class="form-control" value="{{old('mobile1')}}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" placeholder="{{translate('Phone 2')}}" id="mobile2" name="mobile2" class="form-control" value="{{old('mobile2')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" placeholder="{{translate('Whatsapp Number')}}" id="whatsapp_number" name="whatsapp_number" class="form-control" value="{{old('whatsapp_number')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <br>
                            <input type="radio" name="gender" value="male" @if (old('gender') == "male") {{ 'checked' }} @else {{'checked'}} @endif> <label class="col-from-label">Male</label>
                            <input type="radio" name="gender" value="female" @if (old('gender') == "female") {{ 'checked' }} @endif><label class="col-from-label">Female</label> 
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="date" placeholder="{{translate('DOB')}}" id="dob" name="dob" class="form-control" value="{{old('dob')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Profession')}}" id="profession" name="profession" class="form-control" value="{{old('profession')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Contact Position')}}" id="contact_position" name="contact_position" class="form-control" value="{{old('contact_position')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Website')}}" id="website" name="website" class="form-control" value="{{old('website')}}">
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Street Address')}}" id="street_address" name="street_address" class="form-control" value="{{old('street_address')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('City')}}" id="city" name="city" class="form-control" value="{{old('city')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('State')}}" id="state" name="state" class="form-control" value="{{old('state')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Country')}}" id="country" name="country" class="form-control" value="{{old('country')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Zip Code / Pincode')}}" id="pincode" name="pincode" class="form-control" value="{{old('pincode')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Facebook')}}" id="facebook" name="facebook" class="form-control" value="{{old('facebook')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Instagram')}}" id="instagram" name="instagram" class="form-control" value="{{old('instagram')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Twitter')}}" id="twitter" name="twitter" class="form-control" value="{{old('twitter')}}">
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="date" placeholder="{{translate('Anniversary')}}" id="anniversary" name="anniversary" class="form-control" value="{{old('anniversary')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Business Name')}}" id="business_name" name="business_name" class="form-control" value="{{old('business_name')}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-from-label" for="name">{{translate('Tax ID Type')}}</label>
                            ...
                            <option value="pan" @if (old('tax_id_type') == "pan") {{ 'selected' }} @endif>PAN</option>
                            <option value="gst" @if (old('tax_id_type') == "gst") {{ 'selected' }} @endif>GST</option>
                            <option value="other" @if (old('tax_id_type') == "other") {{ 'selected' }} @endif>Other</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Tax ID')}}" id="tax_id" name="tax_id" class="form-control" value="{{old('tax_id')}}">
                        </div>
                    </div>
