    ...
    <div class="card">
        ...
        <div class="card-header row gutters-5">
              ...
              <div class="col-md-3 ml-auto">
                  ...
                  <select class="form-control aiz-selectpicker"  data-minimum-results-for-search="Infinity" id="update_payment_status" @if($delivery_status =='cancel') disabled @endif >
  			...
  			<div class="col-md-3 ml-auto">
                  ...
                  <select class="form-control aiz-selectpicker"  data-minimum-results-for-search="Infinity" id="update_delivery_status" @if($delivery_status =='cancel') disabled @endif>
    		...
    		<div class="clearfix float-right">
              ...
              @if(json_decode($order->shipping_address)->state=='Uttar Pradesh')   
        			<tr>
        				...
        				<td>
        					{{ single_price($order->orderDetails->sum('tax')/2) }}
        				</td>
        			</tr>
              <tr>
                <td>
