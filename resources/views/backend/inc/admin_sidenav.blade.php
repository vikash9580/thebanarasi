        ...
        <div class="aiz-side-nav-wrap">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                           <li class="aiz-side-nav-item">
                             ...
                             <li class="aiz-side-nav-item">
                                <a href="{{ route('normal.customer') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Normal Customer list') }}</span>
                                </a>
                            </li>
                             <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.wholesle') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Wholesale Customer list') }}</span>
                                </a>
                            </li>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                             ...
                             <li class="aiz-side-nav-item">
                                <a href="{{ route('agent_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['agent_report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Agent Report') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))
                  <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('state.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['state.index','state.edit','state.update'])}}">
                                <span class="aiz-side-nav-text">Shipping States</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('city.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['city.index','city.edit','city.update'])}}">
                                <span class="aiz-side-nav-text">Shipping Cities</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('pincode.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['pincode.index','pincode.edit','pincode.update'])}}">
                                <span class="aiz-side-nav-text">Shipping Pincodes</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('whatsapp.view_whatsapp')}}" class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">Whatsapp</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('22', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-network-wired aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('CRM')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{route('crm.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['crm.index', 'crm.create', 'crm.quotation', 'crm.user_info'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Seller')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('crm.allquotation')}}" class="aiz-side-nav-link {{ areActiveRoutes(['crm.allquotation', 'crm.viewquotation', 'crm.quotationbyseller'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Quotation')}}</span>
                                </a>
                            </li>
                            {{-- <li class="aiz-side-nav-item">
                                <a href="{{route('crm.all_orders')}}" class="aiz-side-nav-link {{ areActiveRoutes(['crm.all_orders', 'crm.show_orders'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Orders')}}</span>
                                </a>
                            </li> --}}
                            <li class="aiz-side-nav-item">
                                <a href="{{route('contact.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['contact.index', 'contact.create', 'contact.edit', 'contact.import'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Follow-Up')}}</span>
                                </a>
                            </li>
                          <li class="aiz-side-nav-item">
                                <a href="{{route('crm.dashboard')}}" target="_blank" class="aiz-side-nav-link {{ areActiveRoutes(['crm.dashboard'])}}">
                                    <span class="aiz-side-nav-text">{{translate('CRM')}}</span>
                                </a>
                            </li>
                        </ul>
                          ...
                          <li class="aiz-side-nav-item">
                            <a href="{{route('enquiry.enqiry_view')}}" class="aiz-side-nav-link">
