...
Route::prefix('v1/auth')->group(function () {
    ...
    Route::post('send_otp', 'Api\AuthController@send_otp');
...
Route::prefix('v1')->group(function () {
    ...
    Route::get('cart_delete/{id}', 'Api\CartController@cartDelete');
    ...
    Route::get('detail_check/{user_id}/{product_id}/{varient_name}', 'Api\WishlistController@detailCheck');
    ...
    Route::delete('wishlists', 'Api\WishlistController@destroy');
    ...
    Route::post('user_update', 'Api\UserController@updateName');
     Route::post('user_profile_image', 'Api\UserController@updateProfileImage');
    ...
    Route::get('countries/', 'Api\AddressController@country');
    Route::get('states/{name}', 'Api\AddressController@state');
    Route::get('city/{id}', 'Api\AddressController@city');
    Route::get('pincode/{id}', 'Api\AddressController@pincode');
    ...
    Route::post('payment_initialization','Api\OrderController@paymentInitialization');
    Route::post('verify_payment_signature','Api\OrderController@verify_payment_signature');
    Route::post('order_cancel', 'Api\OrderController@order_cancel');
