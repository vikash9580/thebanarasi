...
Route::get('/users/wholesale_customer_registration', 'HomeController@wholesale_customer_registration')->name('user.wholesale_customer_registration');
Route::get('/users/request_sample', 'HomeController@request_sample')->name('user.request_sample');
Route::post('/users/request_sample_payment', 'HomeController@request_sample_payment')->name('request_sample.payment');
...
Route::post('/cart/updateCartSummary', 'CartController@updateCartSummary')->name('cart.updateCartSummary');
...
Route::post('/checkout/apply_wallet', 'CheckoutController@apply_wallet')->name('checkout.apply_wallet');
Route::post('/checkout/remove_wallet_discount', 'CheckoutController@remove_wallet_discount')->name('checkout.remove_wallet_discount');
...
//CCAvenue Start
Route::get('ccavenue', 'CcavenueController@ccavenue');
Route::any('/ccavenue/success', 'CcavenueController@success')->name('ccavenue.success');
Route::any('/ccavenue/cancel', 'CcavenueController@cancel')->name('ccavenue.cancel');
Route::get('/ccavenue/payment_status', 'CcavenueController@payment_status')->name('ccavenue.payment_status');
Route::get('/ccavenue/payment_process', 'CcavenueController@payment_process')->name('ccavenue.payment_process');
//CCAvenue END
...
Route::post('/subscribers/contact_us', 'SubscriberController@contact_us')->name('subscribers.contact_us');
...
Route::group(['middleware' => ['user', 'verified','unbanned']], function(){
	...
	Route::post('/new-phone-verify', 'HomeController@verify_phone')->name('user.phone.verify');
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::get('/orders/cancel/{id}', 'OrderController@order_cancel')->name('orders.cancel');
	Route::post('/orders/details', 'OrderController@order_details')->name('orders.details');
	Route::post('/orders/update_delivery_status', 'OrderController@update_delivery_status')->name('orders.update_delivery_status');
	Route::post('/orders/update_delivery_status_single', 'OrderController@update_delivery_status_single')->name('orders.update_delivery_status_single');
...
Route::get('/shops/create', 'HomeController@wholesale_customer_registration');
...
Route::post('/addresses/state_list', 'AddressController@state_list')->name('addresses.state_list');
Route::post('/addresses/city_list', 'AddressController@city_list')->name('addresses.city_list');
Route::post('/addresses/pincode_list', 'AddressController@pincode_list')->name('addresses.pincode_list');
...
Route::get('/whatsapp', 'HomeController@whatsapp')->name('whatsapp.home');
Route::post('/whatsapp_update', 'HomeController@whatsapp_update')->name('whatsapp.update');
...
Route::post('/addresses/pincode_list', 'AddressController@pincode_list')->name('addresses.pincode_list');
Route::post('/addresses/pincode_list_new', 'AddressController@pincode_list_new')->name('addresses.pincode_list_new');
Route::post('/addresses/update_address', 'AddressController@update')->name('addresses.update');

//Custom page
Route::get('/{slug}', 'PageController@show_custom_page')->name('custom-pages.show_custom_page');


Route::post('enquiry', 'ContactFormController@enquiry')->name('enquiry');